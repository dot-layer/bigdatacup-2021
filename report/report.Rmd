...
## Breaking down offensive/defensive zone faceoffs to the second
We now take a more detailed look at sequences following an offensive zone faceoff.
We have already gathered some evidence that winning such faceoffs increases the chances of scoring a goal.
Experience also tells us that winning an offensive faceoff cleanly "often" leads to a quick shot from the point or, more generally, to a scoring chance of some sort.
It is therefore intuitive to think that the (quantified) effect of winning an offensive faceoff should be most prominent in the very first seconds following the faceoff and that it should then become less and less relevant over time, may the sequence goes on for a while.
