...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{"figures/bar_off_nhl.png"}
...
- with enough data, we can conclude the increase is significant 
- the effect of winning a faceoff does not lasts forever (about 20 secondes)
- CONCLUSION OT or TEAMS comparisons

We were able to breakdown the faceoffs in different situations, but we think it would also be interesting to explore other ideas:
